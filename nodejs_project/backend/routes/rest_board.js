...
// http://localhost:9090/rest_board/list -> 게시판 접속 불가
...
//upload.single(form태그에서 file의 name이 file이다) 
//<input type="file" name="file"/> : 이 때 name 속성값
//파일 전송시 form 태그에 enctype="form-data/multipart" 속성이 반드시 있어야 한다
//ejs나 jsp에서 사용

//ajax로 전송할 때는 formData 라는 객체를 이용해서 보내야 한다
//$.ajax나 axios 모던스트립트. fetch라는 ajax모듈 추가됨
